...
# setup
from otour.module.setup_common_functions import (setup_driver, get_current_dir, get_parent_dir)
# manager
...
from otour.module.wel_common_functions import (
    homepage_open, login, travel_products_package, select_supplier, select_product, fill_reservation_form, input_traveler_info,
...
def main():
    ...
    welfare_mall_label = "channelSeqArr2"
    click_channel_option(driver, wait, welfare_mall_label)
    # 예약 상세 진입
