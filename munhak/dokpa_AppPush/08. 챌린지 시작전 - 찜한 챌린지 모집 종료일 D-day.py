...
from munhak.module.dokpa_common_functions import (
    dokpa_enter, some_function,  all_challenge_apply, challenge_apply_wishlist)
...
def main():
    ...
    try:
        ...
        challenge_name_value = "서하 자동화 테스트 - 찜한 챌린지 모집 종료일 01" # 챌린지명 입력
    ...
    try:
        ...
        return
    try:
        challenge_apply_wishlist(driver, wait, challenge_name_value)
        print("챌린지 찜하기 버튼 클릭 성공")
    except Exception as e:
