...
from munhak.module.admin_common_functions import (
    ...
    challenge_save, generate_date_range, challenge_tab, challenge_register)
    # homepage
...
from munhak.module.dokpa_common_functions import (
    dokpa_enter, some_function, all_challenge_apply, challenge_list)
...
def main():
    ...
    try:
        ...
        challenge_name_value = "서하 자동화 테스트 - 시작 3일전 01" # 챌린지명 입력
